...
class ResnetBuilder(object):
    ...
    @staticmethod
    def build_resnet_5(input_shape, num_outputs):
        return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 2, 1, 1])

    #     @staticmethod
    #     def build_resnet_4(input_shape, num_outputs):
    #         return ResnetBuilder.build(input_shape, num_outputs, basic_block, [2, 1, 1])
